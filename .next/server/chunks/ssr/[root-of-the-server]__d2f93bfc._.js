 ...
 */ const Hero = ({ onSearch, searchActive, matched: matchedProp })=>{
    ...
    const handleSelectionFilter = (filterValue)=>{
        setSelectedFilters((prev)=>prev.includes(filterValue) ? prev.filter((v)=>v !== filterValue) : [
                ...prev,
                filterValue
            ]);
    };
    const handleSearch = (e)=>{
        ...
        // Only apply status-based selection filters
        selectedFilters.forEach((f)=>{
            if (f === 'Ready' || f === 'New Launch' || f === 'RERA Approved' || f === 'Under Construction' || f === 'Upcoming') {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: selectionFilters.map((filter)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        className: `px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-medium rounded-full transition-colors ${selectedFilters.includes(filter.value) ? 'bg-white text-[#0A0A0A]' : 'bg-white/10 text-white hover:bg-white/20'}`,
                                        onClick: ()=>handleSelectionFilter(filter.value),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2f93bfc._.js.map