...
"[project]/src/app/residential/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ResidentialPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResidentialPage.useEffect": ()=>{
            setLoading(true);
            fetch("/api/properties").then({
                "ResidentialPage.useEffect": (res)=>res.json()
            }["ResidentialPage.useEffect"]).then({
                "ResidentialPage.useEffect": (data)=>{
                    if (data.success) {
                        setProperties(data.properties.filter({
                            "ResidentialPage.useEffect": (p)=>p.propertyType === "Residential"
                        }["ResidentialPage.useEffect"]));
                    }
                    setLoading(false);
                }
            }["ResidentialPage.useEffect"]).catch({
                "ResidentialPage.useEffect": ()=>setLoading(false)
            }["ResidentialPage.useEffect"]);
        }
    }["ResidentialPage.useEffect"], []);
...
_s(ResidentialPage, "5+PGa5MIxCoThlSZI1g7jQNaZr0=");
_c = ResidentialPage;
const __TURBOPACK__default__export__ = ResidentialPage;
var _c;
__turbopack_context__.k.register(_c, "ResidentialPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_5fcdc3eb._.js.map