    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArticlesPage.useEffect": ()=>{
            ...
            fetch('/api/articles').then({
                "ArticlesPage.useEffect": (res)=>res.json()
            }["ArticlesPage.useEffect"]).then({
                "ArticlesPage.useEffect": (data)=>{
...
_s(ArticlesPage, "0dK2+Y1ttBGIrEM2H77jdi3cOA4=");
_c = ArticlesPage;
var _c;
...
//# sourceMappingURL=src_e7fb4718._.js.map