...
"[project]/src/app/commercial/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CommercialPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommercialPage.useEffect": ()=>{
            setLoading(true);
            fetch("/api/properties").then({
                "CommercialPage.useEffect": (res)=>res.json()
            }["CommercialPage.useEffect"]).then({
                "CommercialPage.useEffect": (data)=>{
                    if (data.success) {
                        setProperties(data.properties.filter({
                            "CommercialPage.useEffect": (p)=>p.propertyType === "Commercial"
                        }["CommercialPage.useEffect"]));
                    }
                    setLoading(false);
                }
            }["CommercialPage.useEffect"]).catch({
                "CommercialPage.useEffect": ()=>setLoading(false)
            }["CommercialPage.useEffect"]);
        }
    }["CommercialPage.useEffect"], []);
...
_s(CommercialPage, "5+PGa5MIxCoThlSZI1g7jQNaZr0=");
_c = CommercialPage;
const __TURBOPACK__default__export__ = CommercialPage;
var _c;
__turbopack_context__.k.register(_c, "CommercialPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_27217521._.js.map