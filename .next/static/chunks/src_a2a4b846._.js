...
"[project]/src/app/land/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LandPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LandPage.useEffect": ()=>{
            setLoading(true);
            fetch("/api/properties").then({
                "LandPage.useEffect": (res)=>res.json()
            }["LandPage.useEffect"]).then({
                "LandPage.useEffect": (data)=>{
                    if (data.success) {
                        setProperties(data.properties.filter({
                            "LandPage.useEffect": (p)=>p.propertyType === "Land"
                        }["LandPage.useEffect"]));
                    }
                    setLoading(false);
                }
            }["LandPage.useEffect"]).catch({
                "LandPage.useEffect": ()=>setLoading(false)
            }["LandPage.useEffect"]);
        }
    }["LandPage.useEffect"], []);
...
_s(LandPage, "5+PGa5MIxCoThlSZI1g7jQNaZr0=");
_c = LandPage;
const __TURBOPACK__default__export__ = LandPage;
var _c;
__turbopack_context__.k.register(_c, "LandPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_a2a4b846._.js.map