...
const LocationAdvantages: React.FC<LocationAdvantagesProps> = ({ addressUrl, advantages }) => {
  return (
      ...
      <div className=" mx-auto">
        <div className="flex flex-col gap-6 max-w-[1280px] mx-auto">
          ...
          <div className="flex gap-8">
            {/* Map Section */}
            <div className="relative w-[66%] h-[372px] rounded-lg overflow-hidden bg-gray-200">
              {addressUrl ? (
                <iframe
                  src={addressUrl}
                  width="100%"
